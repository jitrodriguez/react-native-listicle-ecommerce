...
function Input({ label, type, isPassword, onChangeText, value, style, placeholder, options, ...props }) {
    ...
    <View style={styles.container}>
      ...
      {type === 'picker' ? (
        <Pressable style={styles.inputContainer} onPress={() => setIsPickerModalVisible(true)}>
          <Text style={[styles.input, !value?.title ? styles.placeholder : {}, style]}>{value?.title || placeholder}</Text>
